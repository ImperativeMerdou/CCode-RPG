# CONSEQUENCES — scheduled, dated, coming

Deferred outcomes with due dates. Different from clocks (which tick on acts): these fire on the CALENDAR unless something stops them. Check at every session start against the date in world.md. When one fires, play it; when one is defused, strike it with a line about how.
...
| 30 Flamerule (Godsday) | The Mouth prints Salazar's interview piece, family angle and all | Merdou changes the deal before it typesets | Session 1 |
